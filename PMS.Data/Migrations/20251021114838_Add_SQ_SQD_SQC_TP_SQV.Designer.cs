...
namespace PMS.Data.Migrations
{
    ...
    [Migration("20251021114838_Add_SQ_SQD_SQC_TP_SQV")]
    partial class Add_SQ_SQD_SQC_TP_SQV
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PMS.Core.Domain.Entities.SalesQuotation", b =>
                {
                    ...
                    b.HasOne("PMS.Core.Domain.Entities.SalesQuotationValidity", "SalesQuotationValidity")
                        .WithOne("SalesQuotation")
                        .HasForeignKey("PMS.Core.Domain.Entities.SalesQuotation", "SqvId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
